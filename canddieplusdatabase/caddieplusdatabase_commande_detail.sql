...
CREATE TABLE `commande_detail` (
  ...
  CONSTRAINT `commande_detail_ibfk_1` FOREIGN KEY (`commande_id`) REFERENCES `commandes` (`commande_id`) ON DELETE CASCADE,
  CONSTRAINT `commande_detail_ibfk_2` FOREIGN KEY (`produit_id`) REFERENCES `produits` (`produit_id`) ON DELETE CASCADE
...
INSERT INTO `commande_detail` VALUES (1,1,4,30),(2,1,3,15),(3,2,6,50),(4,2,7,100);
